...
public class GameManager : MonoBehaviour
{
    ...
    private void InitializeGame()
    {
        ...
        if (ReputationSystem == null) ReputationSystem = gameObject.AddComponent<ReputationSystem>();
        if (IntegrationSystem == null) IntegrationSystem = gameObject.AddComponent<IntegrationSystem>();
    }
    ...
    {
        return IntegrationSystem?.Calculate(ReputationSystem?.GetTags()) ?? new IntegrationResult();
    }
